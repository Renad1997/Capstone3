...
//    public boolean canCancelAppointment(Integer vetAppointment_id) {
//        VetAppointment vetAppointment1 = vetAppointmentRepository.findVetAppointmentById(vetAppointment_id);
//        if(vetAppointment1==null){
...
//        LocalDate appointmentDate = vetAppointment1.getDate();
//        long hoursUntilAppointment = ChronoUnit.HOURS.between(now, appointmentDate);
//
//        return hoursUntilAppointment >= 24; // Allow cancel
//    }
//    public void cancelAppointment(Integer vetAppointment_id) {
//        if (!canCancelAppointment(vetAppointment_id)) {
//            throw new ApiException("Cannot cancel appointment less than one day before the appointment");
//        }
//
//        VetAppointment vetAppointment1 = vetAppointmentRepository.findVetAppointmentById(vetAppointment_id);
//        vetAppointment1.setStatus("Cancelled");
